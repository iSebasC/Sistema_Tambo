...
$pdf->Cell(30,6,utf8_decode('Categoria'),1,0,'C',1);
$pdf->Cell(58,6,'Nombre',1,0,'C',1);
$pdf->Cell(50,6,utf8_decode('Stock'),1,0,'C',1);
$pdf->Cell(35,6,utf8_decode('Descripcion'),1,0,'C',1);
$pdf->Ln(10);

//creamos las filas de los registros según la consulta mysql
require_once "../modelos/dispoproduct.php";
$articulo = new Articulo();

$rspta = $articulo->listarDispo();
...
while ($reg= $rspta->fetch_object()) {
	...
	$pdf->Row(array(utf8_decode($categoria),utf8_decode($nombre),$stock,utf8_decode($descripcion)));
}
