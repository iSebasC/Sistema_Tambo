...
switch ($_GET["op"]) {
	...
	if (isset($fetch)) {
		...
		in_array(2, $valores)?$_SESSION['inventario']=1:$_SESSION['inventario']=0;
		in_array(3, $valores)?$_SESSION['clientes']=1:$_SESSION['clientes']=0;
		in_array(4, $valores)?$_SESSION['ventas']=1:$_SESSION['ventas']=0;
		in_array(5, $valores)?$_SESSION['acceso']=1:$_SESSION['acceso']=0;
		in_array(6, $valores)?$_SESSION['consultac']=1:$_SESSION['consultac']=0;
		in_array(7, $valores)?$_SESSION['consultav']=1:$_SESSION['consultav']=0;
		in_array(8, $valores)?$_SESSION['productos']=1:$_SESSION['productos']=0;
		in_array(8, $valores)?$_SESSION['proveedor']=1:$_SESSION['proveedor']=0;
